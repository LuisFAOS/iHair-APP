...
const validations = Yup.object().shape({
    name: Yup.string("O nome deve ser uma string.")
        ...
        .matches('^[a-zA-Z0-9àèìòùáéíóúâêîôûãõÀÈÌÒÙÁÉÍÓÚÂÊÎÔÛÃÕ ]+$','Nome inválido.')
        .required("Nome do salão é obrigatório."),

    address_number: Yup.string("O número deve ser uma string.")
        .trim()
        .max(20, "Número muito longo.")
        .required("Número é obrigatório."),
        
    contact_phone: Yup.string("O Tel/Cel deve ser uma string.")
        .trim()
